Nodes_Hash={:N1acdf=>{:type=>"inject", :repeat=>"1", :wires=>[[:N80741]], :inputNodeid=>[], :last_time=>0.0, :flow_controll=>1},
 :N80741=>{:type=>"LED", :LEDtype=>"GPIO", :targetPort=>"0", :targetPort_mode=>"2", :onBoardLED=>"", :wires=>[], :inputNodeid=>[:N1acdf]},
 :N71e94=>{:type=>"inject", :repeat=>"1.5", :wires=>[[:Nf1b82]], :inputNodeid=>[], :last_time=>0.0, :flow_controll=>1},
 :Nf1b82=>{:type=>"LED", :LEDtype=>"GPIO", :targetPort=>"1", :targetPort_mode=>"2", :onBoardLED=>"", :wires=>[], :inputNodeid=>[:N71e94]}}
DatasBuffer = []
