Nodes_Hash={:N521dd=>{:type=>"inject", :repeat=>"1", :wires=>[[:Nc9a12]], :inputNodeid=>[], :last_time=>0.0, :flow_controll=>1},
 :Nc9a12=>{:type=>"LED", :LEDtype=>"GPIO", :targetPort=>"0", :targetPort_mode=>"2", :onBoardLED=>"", :wires=>[], :inputNodeid=>[:N521dd]}}
DatasBuffer = []
