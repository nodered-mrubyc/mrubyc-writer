Nodes_Hash={:N8ec3b=>{:type=>"inject", :repeat=>"1", :wires=>[[:Neb951]], :inputNodeid=>[], :last_time=>0.0, :flow_controll=>1},
 :Neb951=>{:type=>"GPIO", :WriteType=>"PWM", :GPIOType=>"write", :targetPort_digital=>"16", :targetPort_mode=>"1", :targetPort_PWM=>"16", :PWM_num=>"2", :cycle=>"NaN", :double=>"2", :time=>"95a", :rate=>"50", :wires=>[], :inputNodeid=>[:N8ec3b]}}
DatasBuffer = []
