Nodes_Hash={:N6f473=>{:type=>"inject", :repeat=>"1", :wires=>[[:N44086]], :inputNodeid=>[], :last_time=>0.0, :flow_controll=>1},
 :N44086=>{:type=>"LED", :LEDtype=>"GPIO", :targetPort=>"0", :targetPort_mode=>"1", :onBoardLED=>"", :wires=>[], :inputNodeid=>[:N6f473]}}
DatasBuffer = []
